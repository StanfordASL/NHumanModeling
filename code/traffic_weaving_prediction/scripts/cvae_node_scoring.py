    ...
    def __init__(self):
        with tf.Graph().as_default() as g:
            ...
            tf.saved_model.loader.load(self.sess,
                                       ...
                                       model_dir)
            self.y = g.get_tensor_by_name("human/car2_1/outputs/y:0")
            self.car1 = g.get_tensor_by_name("robot/car1:0")
            self.car2 = g.get_tensor_by_name("human/car2:0")
            ...
            self.car1_future = g.get_tensor_by_name("robot/car1_future:0")
            self.car1_future_x = g.get_tensor_by_name("robot/car1_future_x:0")
            self.car1_future_y = g.get_tensor_by_name("robot/car1_future_y:0")
