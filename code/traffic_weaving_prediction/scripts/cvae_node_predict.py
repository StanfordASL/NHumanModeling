...
class Predictor(object):
    ...
    def prediction_callback(self, input_msg):
        ...
        feed_dict = {"robot/car1:0": multiarray_to_numpy(input_msg.car1),
                     "human/car2:0": multiarray_to_numpy(input_msg.car2),
                     "extras:0": multiarray_to_numpy(input_msg.extras),
                     "traj_lengths:0": multiarray_to_numpy(input_msg.traj_lengths),
                     "robot/car1_future:0": multiarray_to_numpy(input_msg.car1_future),
        ...
        y, z = self.sess.run(["human/car2_1/outputs/y:0",
                              "human/car2_1/outputs/z:0"], 
                              feed_dict=feed_dict)
                              # options=options,
